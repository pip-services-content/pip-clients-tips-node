...
class TipsSenecaClientV1 extends pip_services_seneca_node_1.CommandableSenecaClient {
    constructor(config) {
        super('tips');
        if (config != null)
...
exports.TipsSenecaClientV1 = TipsSenecaClientV1;
//# sourceMappingURL=TipsSenecaClientV1.js.map