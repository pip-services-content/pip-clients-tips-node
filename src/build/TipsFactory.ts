...
export class TipsFactory extends Factory {
	...
	constructor() {
		...
		this.registerAsType(TipsFactory.DirectClientV1Descriptor, TipsDirectClientV1);
		this.registerAsType(TipsFactory.HttpClientV1Descriptor, TipsHttpClientV1);
		this.registerAsType(TipsFactory.SenecaClientV1Descriptor, TipsSenecaClientV1);
	}
